...
> **SENAI — Mini Sistema**
>
> Sistema desenvolvido durante minha formação no SENAI utilizando PHP e PostgreSQL.
>
> O projeto possui funcionalidades de cadastro, consulta, atualização e exclusão de alunos, além de sistema de login e sessões.
